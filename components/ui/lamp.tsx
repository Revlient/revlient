  ...
  return (
    <LampContainer>
      <motion.h1
        ...
        className="mt-8 text-black py-4 text-center text-4xl font-semibold tracking-tight md:text-7xl"
      >
        Exquisite Luxury <br /> Redefined
      </motion.h1>
      ...
      >
        <div className="flex flex-col items-center">
          <p className="text-black mb-2 font-medium">Discover More</p>
          <svg 
            width="24" 
            height="24" 
            viewBox="0 0 24 24" 
...
export const LampContainer = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center overflow-hidden bg-gray-50 w-full rounded-md z-0",
        className
      )}
    >
      <div className="relative flex w-full flex-1 scale-y-125 items-center justify-center isolate z-0 ">
        ...
        >
          ...
          <div className="absolute w-40 h-[100%] left-0 bg-gray-50 bottom-0 z-20 [mask-image:linear-gradient(to_right,white,transparent)]" />
        </motion.div>
        <motion.div
          initial={{ opacity: 0.5, width: "15rem" }}
          whileInView={{ opacity: 1, width: "30rem" }}
        ...
        >
          <div className="absolute w-40 h-[100%] right-0 bg-gray-50 bottom-0 z-20 [mask-image:linear-gradient(to_left,white,transparent)]" />
          <div className="absolute w-[100%] right-0 bg-gray-50 h-40 bottom-0 z-20 [mask-image:linear-gradient(to_top,white,transparent)]" />
        </motion.div>
        <div className="absolute top-1/2 h-48 w-full translate-y-12 scale-x-150 bg-gray-50 blur-2xl"></div>
        ...
        <motion.div
          ...
          className="absolute inset-auto z-50 h-0.5 w-[30rem] -translate-y-[7rem] bg-amber-600"
        ></motion.div>

        <div className="absolute inset-auto z-40 h-44 w-full -translate-y-[12.5rem] bg-gray-50"></div>
      </div>
